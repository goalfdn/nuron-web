...
export default function Privacy() {
  ...
  return (
    ...
    <div className="bg-trusty-500">
      ...
      <h1 className="pb-5 text-serenity-shade">{"Nuron's Privacy Policy"}</h1>
      ...
      <h3 className="pt-5 pb-2">Collection of your Personal Information</h3>
      <p className="text-5">{
      ...
      <h3 className="pt-5 pb-2">Sharing Information with Third Parties</h3>
      <p className="text-5">{
      ...
      <h3 className="pt-5 pb-2">Right to Deletion</h3>
      <p className="text-5">{
      ...
      <h3 className="pt-5 pb-2">Children Under Thirteen</h3>
      <p className="text-5">{
      ...
      <h3 className="pt-5 pb-2">E-mail Communications</h3>
      <p className="text-5">{
      ...
      <h3 className="pt-5 pb-2">External Data Storage Sites</h3>
      <p className="text-5">{
        "We may store your data on servers provided by third-party hosting vendors with whom we have contracted."
      }</p>
      <h3 className="pt-5 pb-2">Changes to this Statement</h3>
      <p className="text-5">{
      ...
      <h3 className="pt-5 pb-2">Contact Information</h3>
      <p className="text-5">{
